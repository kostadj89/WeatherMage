...
public class PixelizePass : ScriptableRenderPass
{
    ...
    public PixelizePass(PixelizeFeature.CustomPassSettings settings)
    {
        ...
        if (material == null)
            material = CoreUtils.CreateEngineMaterial(Shader.Find("Hidden/Pixelize"));
        //pixelScreenHeight = settings.screenHeight;
        //pixelScreenWidth = (int)(pixelScreenHeight * (Screen.width / (float)Screen.height));
    }
    ...
    public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
    {
        ...
        material.SetVector("_BlockSize", new Vector2(1.0f / (float)pixelScreenWidth, 1.0f / (float)pixelScreenHeight));
